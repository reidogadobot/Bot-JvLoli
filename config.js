...
const blockedmsg = '*😜 Seu número foi bloqueado pelo meu proprietário 😜*'
...
let mess = {
    ...
    only: {
        group: '❌ Use esse comando em um grupo! ❌',
        ownerG: '❌ Este comando só pode ser usado pelo gr                                                              >
        ownerB: '⚠️Apenas o 🇯​🇻​ 🇧​🇴​🇹​🇸​pode executar esse coman                                                              >
        admin: '❌ *SILÊNCIO!* Somente um administrador da                                                              >
        Badmin: '❌ Este comando só pode ser usado quando                                                               >
    }
}
...
+ 'FN:Meu criador^~^\n'
+ 'ORG:Ian;\n'
+ 'TEL;type=CELL;type=VOICE;waid=555185480669:+55 51 8548-                                                              >
+ 'END:VCARD'
//vcard do propietário, mude os numeros de acordo com o fo                                                              >
//ele corresponde
